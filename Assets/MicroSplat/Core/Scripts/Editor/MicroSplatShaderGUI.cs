...
{
   public static readonly string MicroSplatVersion = "2.8";
   ...
   void InitModules()
   {
      if (modules.Count == 0)
      {
         ...
         modules.Add(new Module("https://assetstore.unity.com/#!/content/96482?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_globaltexture"));
#endif
#if !__MICROSPLAT_SNOW__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/96486?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_snow"));
#endif
#if !__MICROSPLAT_TESSELLATION__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/96484?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_tessellation"));
#endif
#if !__MICROSPLAT_DETAILRESAMPLE__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/96480?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_detailresample"));
#endif
#if !__MICROSPLAT_TERRAINBLEND__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/97364?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_terrainblending"));
#endif
#if !__MICROSPLAT_STREAMS__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/97993?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_streams"));
#endif
#if !__MICROSPLAT_ALPHAHOLE__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/97495?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_alphahole"));
#endif
#if !__MICROSPLAT_TRIPLANAR__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/96777?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_triplanaruvs"));
#endif
#if !__MICROSPLAT_TEXTURECLUSTERS__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/104223?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_textureclusters"));
#endif
#if !__MICROSPLAT_WINDGLITTER__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/105627?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_windglitter"));
#endif
#if !__MICROSPLAT_PROCTEX__
         modules.Add(new Module("https://assetstore.unity.com/#!/content/143039?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_proctexture"));
#endif
#if !__MICROSPLAT_LOWPOLY__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-low-poly-look-146119?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_lowpoly"));
#endif
//#if !__MICROSPLAT_ADVANCED_DETAIL__
//         modules.Add(new Module("https://assetstore.unity.com/#!/content/108321?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_advanceddetails"));
//#endif
         //#if !CASCADE
