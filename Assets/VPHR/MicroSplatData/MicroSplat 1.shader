...
//   Compiled with MicroSplat 2.8
//   Unity : 2018.3.6f1
//   Platform : WindowsEditor
//   RenderLoop : Surface Shader
//////////////////////////////////////////////////////

Shader "MicroSplat/Plane" {
   Properties {
   ...
   // ADVANCEDTERRAIN_ENTRYPOINT 
      ...
      MicroSplatLayer SurfImpl(Input i, float3 worldNormalVertex)
      {
         ...
         UNITY_INITIALIZE_OUTPUT(Config,config);
            ...
            ProceduralSetup(i.worldPos, height, procNormal, up, weights, origUV, config, ddx(origUV), ddy(origUV), ddx(i.worldPos), ddy(i.worldPos));
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Plane_Base"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Plane_Base"
